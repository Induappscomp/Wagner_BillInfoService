...
namespace TradingBell.WebCat.CommonServices
{
    public class PayPalService
    {
        ...
        //public string getuserinfo(string authorization_Code)
        //{
        ...
        //    //    {
        //    //        using (var request = new HttpRequestMessage(new HttpMethod("POST"), "https://api.sandbox.paypal.com/v1/identity/openidconnect/tokenservice"))
        //    //        {
        ...
        //    //            objErrorHandler.CreateLog("after request");
        //    //        }
        //    //    }
        //    //}
        //    //catch (Exception ex)
        ...
        //    byte[] bytes = Encoding.UTF8.GetBytes("ASvOVqyqxc-yuMXaYFBc3KyqixfkUi1kaYultQ_6vF0Ol2eNYfHuz6TAsbEscPvN4Ysp4IkLzLsmZET7");
        //    string base64 = Convert.ToBase64String(bytes);
        ...
        //    request.AddHeader("authorization", "ASvOVqyqxc-yuMXaYFBc3KyqixfkUi1kaYultQ_6vF0Ol2eNYfHuz6TAsbEscPvN4Ysp4IkLzLsmZET7:EPWkk1FgRc8poOotONxToq1bVx5avy0pzFyIdeI_XPtDs2lve-Pb6j2xMsMwDjhrgB_nCrcRY4QcvIb3");
        //    request.AddParameter("application/x-www-form-urlencoded", "grant_type=authorization_code&code={" + authorization_Code + " }");
        //    IRestResponse response = client.Execute(request);
        //    objErrorHandler.CreateLog(response.ResponseStatus.ToString() + response.ResponseUri.ToString());
        ...
        //private static async Task<PayPalAccessToken> GetPayPalAccessTokenAsync()
        //{ 
        //    var clientId =System.Configuration.ConfigurationManager.AppSettings["clientId"].ToString();
        //    var secret = System.Configuration.ConfigurationManager.AppSettings["clientSecret"].ToString();
        ...
        public int SaveUserProfile(string payer_email, string first_name, string country, string city, string last_name, string zip, string address_street, string address_name)
        {
            ...
            try
            {
                ...
                oRegInfo.Status = "I";
                oRegInfo.RegType = "N";
                oRegInfo.Password = "wag" + first_name.ToString() + last_name.ToString();
                string Newpassword = objcrpengine.StringEnCrypt_password("wag" + first_name.ToString() + last_name.ToString());
