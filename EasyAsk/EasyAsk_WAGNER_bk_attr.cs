                                            ...
                                            if (i == 2)
                                            {
                                                if (StrValue.Length > 2)
                                                {
                                                    if (StrValue[2].Contains("~") == false)
                                                    {
                                                        ...
                                                        {
                                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/" + x1 + "/" + StrValue[StrValue.Length - 2] + "/" + StrValue[StrValue.Length - 1] + "/pl/";
                                                        }
                                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + path;
                                                    ...
                                                    {
                                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ StrValue[1] + "/" + StrValue[2] + "/pl/";
                                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                                    }
                                                }
                        ...
                        foreach (DataRow item1 in subdt.Rows)
                        {
                            if (item1["Publish"].ToString() == "True" || item1["Publish"].ToString() == "1")
                            {
                                //Modified by indu
                                        ...
                                        //{
                                if(item1["CATEGORY_NAME"].ToString().ToLower()!= "carrying & style" )
                                {
