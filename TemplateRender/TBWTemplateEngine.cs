                        ...
                        foreach (DataRow dr in PRODRows)
                        {
                            ...
                            if (attr_datatype.ToUpper().StartsWith("TEX"))
                            {
                                ...
                                else
                                {
                                    ...
                                    objErrorHandler.CreateLog(attName);                                                          
                                    if (package_name.Equals("PRODUCT"))
                                    {
                                        ...
                                        else if (attName.Equals("OVERVIEW"))
                                        {
                                            objErrorHandler.CreateLog("inside OVERVIEW"); 
                                            _stmpl_records.SetAttribute("TBT_Overview" , drstrval);
                                        }
                    ...
                    { }
                            ...
                            */
                            ...
                            else
                            {
                                ...
                                //{
                                //    _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/InStock");
                                //}
                    ...
                    if (HttpContext.Current.Request.QueryString["fid"] != null)
                    {
                        ...
                        if (tmpds != null && tmpds.Tables.Count > 0)
                        {
                           // objErrorHandler.CreateLog("inside product page" + "GET_PARENT_CATEGORY_ID_PATH_INPUT_FAMID" + tmpds.Tables[0].Rows.Count + "---" + HttpContext.Current.Session["EA"].ToString());
                            ...
                            _stmpl_records.SetAttribute("TBT_EA_PATH", HttpUtility.UrlEncode(objSecurity.StringEnCrypt(eapath)));
                            _stmpl_records.SetAttribute("ORG_TBT_EA_PATH", eapath);
                            string currenturl = System.Configuration.ConfigurationManager.AppSettings["CurUrl"].ToString();
                    ...
                    if (dtrow.Length > 0)
                    {
                        foreach (DataRow dr in dtrow)
                        {
                            ...
                            if (dr["ATTRIBUTE_DATATYPE"].ToString().ToUpper().StartsWith("TEX"))
                            {
                                ...
                                {
                                    if (attName.Equals("FEATURES"))

                                    {
                                        //if (descall != "")
                                        //{
                                        //    desc1 = "<br/><br/> <ul class=square_list><li>" + drstrval.Replace(".", "</li><li>") + "</li></ul>";
                                        //}
                                        //else
                                        //{
                                        ...
                                        string query = "SELECT replace(replace(STRING_VALUE,CHAR(13),''),CHAR(10),'</li><li>') FROM TB_FAMILY_SPECS WHERE STRING_VALUE LIKE '%' + CHAR(10) + '%' and ATTRIBUTE_ID = 240 and FAMILY_ID ='" + cdr["FAMILY_ID"].ToString() +"'";
                                       // objErrorHandler.CreateLog(query);
                                        DataSet pddataset = objHelperDB.GetDataSetDB(query);
                                    
                                        if (pddataset != null && pddataset.Tables[0].Rows.Count > 0)
                                        {
                                            drstrval = pddataset.Tables[0].Rows[0][0].ToString();
                                              // .Replace(" . .", "\n").Replace("..", "\n").Replace(". .",".").Replace(". . ", ".").Replace(". .", ".").Replace(".   .",".").Replace(".   .",".").Replace("  ", " ");
                                            drstrval = drstrval.Replace("..", ".");
                                        }
                                       
                                        desc1 = "<br/><ul class=square_list><li>" + drstrval.Replace("•","").Replace("/n", "</li><li>") + "</li></ul>";
                                        //}

                                        desc1 = desc1.Replace("<ul><li></li></ul>", "").Replace("<li></li>", "");
                                    }
                                    else if (attName.Equals("SPECIFICATION") || attName.Equals("SPECIFICATIONS"))
                                    {

                                        desc1 = "<br/><div class=pspec>" + drstrval.Replace("*", "").Replace("\n", "<br/>").Replace("\r", "&nbsp;") +"</div>";
...
if (!desc1.Equals(""))
                    ...
                    if (descall.Length > 800)
                    {
                        descallstring = descall.Substring(0, 800).Replace(">>", ">").Replace("<<", "<") + "...";
                        if (descallstring.EndsWith("</li></ul>") == false)
                        {
                            descallstring = descallstring + "</li></ul>";
                        }
                        _stmpl_records.SetAttribute("TBT_MORE", descallstring.Replace(">>",">").Replace("<<","<") );
                        _stmpl_records.SetAttribute("TBT_MENU_ID", "2");
                ...
                //    objErrorHandler.CreateLog("isProductReplace" + isProductReplace + "-----" + "Issubstitute" + Issubstitute);
                    ...
                    else
                    {
                        ...
                        if (cdr["ETA"].ToString() != string.Empty)
                        {
                            _Eta = string.Format("<tr><td><span>ETA :</span></td><td colspan=\"2\"><b> " + cdr["ETA"].ToString() + "</b></td></tr>");
                        }
                    }
                   // sw4.Stop();
             ...
             // objErrorHandler.CreateLog(_StockStatusTrim+"pd");
                    ...
                    //objErrorHandler.CreateLog(isProductReplace + "--" + Issubstitute + cdr["PRODUCT_ID"].ToString());
                    if ((isProductReplace == true) && (Issubstitute != ""))
                    {
                        _stmpl_records.SetAttribute("TBT_REPLACED", true);
                        // _stmpl_records.SetAttribute("TBT_REPLACED_DETAIL", strReplacedProduct);
                        _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/OutOfStock");
                    }
                    else
                    {
                        ...
                        if (cdr["PROD_STOCK_FLAG"].ToString() == "-2" && cdr["ETA"] != null && cdr["ETA"].ToString() != string.Empty && cdr["ETA"].ToString().Trim() != "PLEASE CALL")
                        {
                            isSameLogic = true;
                        }
                        else if ((cdr["PROD_STOCK_FLAG"].ToString() == "-2" && cdr["PROD_STOCK_STATUS"].ToString() == "False" && cdr["STOCK_STATUS_DESC"].ToString().Trim() == "OUT_OF_STOCK ITEM WILL BE BACK ORDERED") || (cdr["PROD_STOCK_FLAG"].ToString() == "0" && cdr["PROD_STOCK_STATUS"].ToString() == "True" && cdr["STOCK_STATUS_DESC"].ToString().Trim() == "Please_Call") || ((cdr["PROD_STOCK_FLAG"].ToString() == "-2" || cdr["PROD_STOCK_FLAG"].ToString() == "0" ) && cdr["PROD_STOCK_STATUS"].ToString() == "False" && cdr["STOCK_STATUS_DESC"].ToString().Trim() == "SPECIAL_ORDER PRICE & AVAILABILITY TO BE CONFIRMED"))
                        {
                            string eta = "";
                            //Modified byIndu on 21 aug 2020
                            if (cdr["PROD_STOCK_FLAG"].ToString() == "-2" && cdr["ETA"].ToString() != string.Empty && cdr["ETA"].ToString().Trim() != "PLEASE CALL" && cdr["STOCK_STATUS_DESC"].ToString().Trim() == "OUT_OF_STOCK ITEM WILL BE BACK ORDERED")
                            {
                                //string etaShipDays = string.Empty;
                                //etaShipDays = "Ships Out Approx: " + cdr["ETA"].ToString();
                                eta= cdr["ETA"].ToString();
                                //_Tbt_Stock_Status_1 = "";
                                //_stmpl_records.SetAttribute("TBT_STOCK_STATUS_3", etaShipDays);
                                //_Eta = string.Format("<tr><td><span style=\"margin-left:-8px;\">Pre-order to Avoid Missing Out</span></td></tr>");
                            }
                        ...
                        if (isSameLogic)
                        {
                            ...
                            //To display description when PROD_STOCK_FLAG is -2 and eta date not expired
                            if (cdr["PROD_STOCK_FLAG"].ToString() == "-2" && cdr["ETA"].ToString() != string.Empty && cdr["ETA"].ToString().Trim() != "PLEASE CALL")
                            {
                                _Tbt_Stock_Status_1 = "";
                                _Eta = "";
                                _stmpl_records.SetAttribute("TBT_ISINSTOCK", false);
                                _stmpl_records.SetAttribute("TBT_SHOW_SHIPPINGDAYS", false);
                                _stmpl_records.SetAttribute("TBT_SHOW_ETA", true);
                                _stmpl_records.SetAttribute("TBT_ISINSTOCK_STAUS", "Pre-Order");
                                _stmpl_records.SetAttribute("TBT_SHIPPINGDAYS", "ETA: " + cdr["ETA"].ToString());

                                _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/PreOrder");
                            }
                            else if (!_Tbt_Stock_Status.Equals(""))
                        {
                              //  objErrorHandler.CreateLog("_Tbt_Stock_Status "+ _Tbt_Stock_Status);
                            //_stmpl_records.SetAttribute("TBT_STOCK_STATUS", _Tbt_Stock_Status);
                            if (_Tbt_Stock_Status == "Limited Stock")
                            {
                                    //_stmpl_records.SetAttribute("TBT_PLEASE_CALL", "true");
                                    int soh = 0;
                                    string tempstr = (string)objHelperDB.GetGenericDataDB(cdr["PRODUCT_ID"].ToString(), "GET_PRODUCT_SOH", HelperDB.ReturnType.RTString);
                                if (tempstr != null && tempstr != "")
                                    {
                                    soh = Convert.ToInt32(tempstr);
                                    }
                                    // objErrorHandler.CreateLog("soh " + soh);
                                    // soh = objProductServices.GetProductSOH(Convert.ToInt32(cdr["PRODUCT_ID"].ToString()));
                                    //objErrorHandler.CreateLog("soh " + soh);
                               ...
                               _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/InStock");
                                ...
                                {
                                    _stmpl_records.SetAttribute("TBT_PLEASE_CALL", true);
                                _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/LimitedAvailability");
                                }
                            }
                            else {
                                _stmpl_records.SetAttribute("TBT_STOCK_STATUS", _Tbt_Stock_Status);
...
if(isSameLogic ==true )
                        ...
                        _stmpl_records.SetAttribute("TBT_STOCK_STATUS_ETA", _Eta);
                           ...
                           // objErrorHandler.CreateLog("stkstatus" + stkstatus + "stkstatus1" + stkstatus1 + "_Tbt_Stock_Status_2"+ _Tbt_Stock_Status_2);

                            if (_stmpl_records.GetAttribute("TBT_STOCK_HREF")!=null)
                            { 
                           // objErrorHandler.CreateLog("TBT_STOCK_HREF"+_stmpl_records.GetAttribute("TBT_STOCK_HREF").ToString());
                            }
                            if (stkstatus == "INSTOCK" || stkstatus1 == "INSTOCK")
                        {
                                if (_stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                        ...
                        else if ((stkstatus == "ITEM WILL BE BACK ORDERED" || stkstatus1 == "ITEM WILL BE BACK ORDERED" || stkstatus1 == "BACK ORDER ITEM" || stkstatus== "BACK ORDER ITEM") && _stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                            
                        {

                            _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/OutOfStock");
                        }
                        else if (_StockStatus.Contains("TEMPORARY UNAVAILABLE") && _stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                        {
                            _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/OutOfStock");
                        }
                        else if ((_Tbt_Stock_Status.Trim() == "Please Call" || _Tbt_Stock_Status_1.Trim() == "Please Call" || _Tbt_Stock_Status_3.Trim() == "Please Call")&& _stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                        {
                            _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/PreOrder");
                        }
                            //else if (_Tbt_Stock_Status == "Limited Stock")
                            //{
                            //    if (soh > 4)
                            //    {
                            //        _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/LimitedAvailability");
                            ...
                            //    }
                            //    }
                            else if ((stkstatus.Contains("SPECIAL") || stkstatus1.Contains("SPECIAL"))&& _stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                        {
                            _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/LimitedAvailability");
                        }
                        else if (!(_Tbt_Stock_Status_2) && _stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                        {
                            _stmpl_records.SetAttribute("TBT_STOCK_HREF", "https://schema.org/Discontinued");
                        }
                        else
                        {
                                if(_stmpl_records.GetAttribute("TBT_STOCK_HREF") == null)
                  ...
                  //  sw6.Start();
                    ...
                    // swpd.Start();
                    // objErrorHandler.CreateLog("ST_Product_Download b4");
                    ST_Product_Download(cdr["PRODUCT_ID"].ToString());
                   // objErrorHandler.CreateLog("ST_Product_Download after" + downloadST);
                    _stmpl_records.SetAttribute("TBT_DOWNLOAD_DATA", downloadST);
                    _stmpl_records.SetAttribute("TBT_DOWNLOAD", isdownload);
                    downloadST = "";
                    ...
                    DataSet Dsall = objOrderServices.getBulkBuyPrice(Convert.ToInt32(cdr["PRODUCT_ID"].ToString()), Convert.ToInt32(userId));
                            ...
                            foreach (DataRow oDr in Dr)
                            {
                                ...
                                if (oDr["ATTRIBUTE_NAME"].ToString() != "Long Description" && oDr["ATTRIBUTE_NAME"].ToString() != "PROD_CODE")
                                {
                                    if (!string.IsNullOrEmpty(oDr["STRING_VALUE"].ToString()))
                                    {
                                        ...
                                        if (oDr["ATTRIBUTE_NAME"].ToString().ToLower() == "description")
                                        {


                                            try
                                            { //familyitemcount
                                               // objErrorHandler.CreateLog("description ");
                                                HelperDB objhelperDb = new HelperDB();

                                                //string stmt = "select count(product_id) from tb_prod_family where family_id=" + oDr["FAMILY_ID"] + "";
                                                //DataSet Ds_familyitemcount = objhelperDb.GetDataSetDB(stmt);

                                                //if (Ds_familyitemcount == null)
                                                //{
                                                //    objErrorHandler.CreateLog("Ds_familyitemcount is null ");
                                                //}
                                                //else
                                                //{
                                                //    objErrorHandler.CreateLog("Ds_familyitemcount is not null "); }


                                                int count = 0;

                                                //if (Ds_familyitemcount.Tables[0].Rows.Count > 0)
                                                //    count = Ds_familyitemcount.Tables[0].Rows.Count;
                                                //else
                                                try
                                                {
                                                    count = Convert.ToInt16(HttpContext.Current.Session["FamCount"]);
                                                }
                                                catch
                                                { }
                                                string getdes = HttpContext.Current.Session["getdes"].ToString()   ;
                                                //  string sqlexec = "select string_value from TB_FAMILY_SPECS where ATTRIBUTE_ID in (3,14) and STRING_VALUE !='' ";
                                               
                                                if (count >1)
                                                {
                                                   // objErrorHandler.CreateLog("productcount" + count);
                                                    st.SetAttribute("DESCRIPTION", oDr["STRING_VALUE"].ToString());
                                                }
                                                else if (getdes == "true")
                                                {
                                                    st.SetAttribute("DESCRIPTION", oDr["STRING_VALUE"].ToString());
                                                ...
                                                {
                                                   // objErrorHandler.CreateLog("TB_FAMILY_SPECS count" + Dsall.Tables[0].Rows.Count);
                                                }
                                            }
                                            catch (Exception ex)
                                            {
          ...
          //  StringTemplate _stmpl_records = null;
           ...
           // DataRow[] dr = null;
            ...
            if (_pid != "")
            {
                ...
                //objErrorHandler.CreateLog("STP_TBWC_PICKFAMILYPAGEPRODUCT " + _pid);
                if (TempEADs != null && TempEADs.Tables.Count > 0 && TempEADs.Tables[0].Rows.Count > 0)
                {
                    ...
                    //objErrorHandler.CreateLog("inside stproduct");
...
//Date:3 Oct 2017                     
              ...
              //  string requrl = HttpContext.Current.Request.Url.ToString().ToLower();
                ...
                foreach (DataRow dr in dsrecords_dup.Tables[0].Rows)//For Records
                {
                    ...
                    if (dr_cat_id_upper != WesNewsCategoryId && !(dr_cat_id_upper.Contains("SPF-")) && dr1.Length > 0)
                    {
                        ...
                        {
                          //  objErrorHandler.CreateLog(dsSubCat.Tables[0].Rows.Count + "dssubcat");     
                            DataRow[] subrows = dsSubCat.Tables[0].Select("TBT_PARENT_CATEGORY_ID='" + dr["CATEGORY_ID"].ToString() + "' and CATEGORY_NAME not like 'empty'", "CATEGORY_NAME");
                            ...
                            if (subrows.Length > 0)
                            {
                                ...
                                foreach (DataRow subdr in subrows)//For Records
                                {
                                    ...
                                    DataRow[] subrows1 = dsSubCat.Tables[0].Select("TBT_PARENT_CATEGORY_ID='" + subdr["CATEGORY_ID"].ToString() + "' and CATEGORY_NAME not like 'empty'", "CATEGORY_NAME");
                                    Subcatlist1 = "";
                                    subcount = 0;
            ...
            try
            {
             ...
             string path = System.Configuration.ConfigurationManager.AppSettings["CDNBANNER"].ToString() + "Home" + "/";
                ...
                try
                {
                    ...
                    //if (HttpContext.Current.Session["links"] != null)
                    //{
                        //if (HttpContext.Current.Session["links"] != null)
                        //{
                   ...
                   // }
                    //else
                    //{
                    //    var webRequest = WebRequest.Create(@path + "Links.txt");
                    ...
                    //        dataset.ReadXml(new XmlNodeReader(xd));
                    //    }
                    //    HttpContext.Current.Session["links"] = dataset;
                    //    objErrorHandler.CreateLog("banner created from link page");
                    //}
  ...
  string[] pfid = sptcookieval[0].Split(',') ;
         ...
         public string ST_NewProduct_Load()
        {
            ...
            try
            {
               ...
               // JObject o1;
                ...
                //objErrorHandler.CreateLog("inside st_neproductload" + HttpContext.Current.Request.Url);
                ...
                foreach (DataRow dr in tmpds.Tables[0].Rows)//For Records
                {
                 ...
                 // URL_RW_PATH=   objHelperServices.Cons_NewURlASPX("", "AllProducts////WESAUSTRALASIA////" + "////" + dr["CATEGORY_PATH"] + "////" + dr["FAMILY_ID"] + "=" + dr["FAMILY_name"] + "////" + dr["product_ID"] + "=" + dr["Code"], "pd.aspx", true, "");
                    ...
                    if (dr["TWEB Image1"].ToString() != null && dr["TWEB Image1"].ToString() != String.Empty && dr["TWEB Image1"].ToString() != ""){
                        //String strfile1 = System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString() + "prodimages\\" + dr["TWEB Image1"].ToString().Replace("\\", "/");
                        //bool ImageExits = objHelperServices.CheckImageExistCDN(strfile1);
                        //objErrorHandler.CreateLog(ImageExits + "--" + strfile1);
                        //if (ImageExits)
                            prodImage = System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString() + "prodimages" + dr["TWEB Image1"].ToString().Replace("_TH", "_images_200").Replace("\\", "/");
                        //else
                        //    prodImage = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/noimage.gif";
    ...
    //                _stmpl_records.SetAttribute("TBT_TWEB_IMAGE1", GetImagePath(dr["TWEB Image1"]));
          ...
          //          tmpprice = objHelperServices.CheckPriceValueDecimal(dr["prod_price_1"]);
                    if (dr["PROD_COUNT"].ToString() == "1")
                        _stmpl_records.SetAttribute("TBT_YOURCOST", dr["COSt"]);
                    else
         ...
         public string ST_SubFamily_Load(DataSet tempDs)
         {
             ...
             try
             {
               ...
               //  StringTemplate _stmpl_records = null;
                 ...
                 _stmpl_container.SetAttribute("TBT_FAMILY_NAME", drs[0]["FAMILY_NAME"].ToString().Replace("<sub1>", " ").Replace("</sub1>", "").Replace("<sub2>", " ").Replace("</sub2>", "").ToUpper());
                 _stmpl_container.SetAttribute("TBT_FAMILY_TITLE", drs[0]["FAMILY_NAME"].ToString().Replace('"',' '));
                _stmpl_container.SetAttribute("TBT_SHORT_DESCRIPTION", drs[0]["FAMILY_SHORT_DESC"].ToString().Replace("<wagmetades>", "").Replace("</wagmetades>", ""));
                     
                 _stmpl_container.SetAttribute("TBT_DESCRIPTIONS", drs[0]["FAMILY_DESC"].ToString());
                 _stmpl_container.SetAttribute("CDN", System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString());
              //  objErrorHandler.CreateLog(drs[0]["FAMILY_TH_IMAGE"].ToString()+"familyname"+ drs[0]["FAMILY_NAME"].ToString());
                ...
                foreach (DataRow dr in dsrecords.Tables[0].Rows)//For Records
                 {
                     ...
                     desc1="";
                    string drstrval = dr["STRING_VALUE"].ToString();
                    if (attname.Equals("DESCRIPTIONS") || attname.Equals("FEATURES") || attname.Equals("SPECIFICATION") || attname.Equals("SPECIFICATIONS") || attname.Equals("APPLICATIONS") || attname.Equals("NOTES"))
                    {
...

                        {
                            ...
                            string query = "SELECT replace(replace(STRING_VALUE,CHAR(13),''),CHAR(10),'</li><li>') FROM TB_FAMILY_SPECS WHERE STRING_VALUE LIKE '%' + CHAR(10) + '%' and ATTRIBUTE_ID = 240 and FAMILY_ID ='" + dsrecords.Tables[0].Rows[0]["FAMILY_ID"].ToString() + "'";
                            // objErrorHandler.CreateLog(query);
                            DataSet pddataset = objHelperDB.GetDataSetDB(query);
                            ...
                            desc1 = "<br/><ul class=square_list><li>" + drstrval.Replace("•", "").Replace("\n", "</li><li>") + "</li></ul>";


                            desc1 = desc1.Replace("<ul><li></li></ul>", "").Replace("<li></li>", "");

                            if ((descall + desc1).Length > 800)
                            {
                              //  objErrorHandler.CreateLog("inside concatfea");
                                concatfea = false;
                                string descall1 = descall + desc1;
                                descallstring = descall1.Substring(0, 800).ToString();
                                if (descallstring.EndsWith("</li></ul>") == false)
                                {
                                    descallstring = descallstring + "</li></ul>";
                                }
                    ...
                    else if (attname.Contains("OVERVIEW"))
                    {
                        _stmpl_container.SetAttribute("TBT_OVERVIEW", dr["STRING_VALUE"].ToString());
                 ...
                 if (descall.Length > 800)
                    {
                       ...
                       // descallstring = descall.Substring(0, 800).ToString();
                     _stmpl_container.SetAttribute("TBT_MORE", descallstring.Replace(">>",">").Replace("<<","<"));
                     _stmpl_container.SetAttribute("TBT_MENU_ID", "2");
                     descall = descall.Substring(0, descall.Length).ToString();         
                     _stmpl_container.SetAttribute("TBT_DESCALL", descall);
         ...
         public void SendMail_Review(int OrderId, int OrderStatus, bool isau)
         {
             ...
             try
             {
                 ...
                 int tomalamtcount = Convert.ToInt16(System.Configuration.ConfigurationManager.AppSettings["tomalamtcount"].ToString());
                 if (oOrderInfo.TotalAmount >= tomalamtcount)
                 {
                     int UserID = oOrderInfo.UserID; //objHelperServices.CI(Session["USER_ID"].ToString());
                     ...
                     if (sHTML != "")
                     {
                         ...
                         //if (Convert.ToInt16(Session["USER_ROLE"]) == 1 || Convert.ToInt16(Session["USER_ROLE"]) == 2)
                         // {
                         MessageObj.Subject = "Wagner Order Information - " + oPayInfo.PORelease;
                         //}
                         //else
                         //{
                         //    MessageObj.Subject = "Wagner Pending Order Notification - Order No : " + CustomerOrderNo.ToString();
                 ...
                 {
                    // objErrorHandler.CreateLog("Review Mail not send order amt" + oOrderInfo.TotalAmount + "Order Id:" + oOrderInfo.OrderID);
                 }
             }
             catch (Exception ex)
             {
         ...
         private bool GetStockDetails(StringTemplate st, string Pid,string ETA)
         {
             ...
             try
             {
               ...
               //  objErrorHandler.CreateLog("sqlexec " + sqlexec);
                 ...
                 if ((Dsall.Tables[0].Rows[0]["SUPPLIER_ITEM_CODE"] == null || Dsall.Tables[0].Rows[0]["SUPPLIER_ITEM_CODE"].ToString().Trim() == "") || (Dsall.Tables[0].Rows[0]["SUPPLIER_ID"].ToString() == null || Dsall.Tables[0].Rows[0]["SUPPLIER_ID"].ToString().Trim() == ""))
                 {
                     return true;
                 }
                 if (Dsall.Tables[0].Rows[0]["product_id"] != null && Dsall.Tables[0].Rows[0]["product_id"].ToString() == string.Empty && Dsall.Tables[0].Rows[0]["PRODUCT_CODE"] != null && Dsall.Tables[0].Rows[0]["PRODUCT_CODE"].ToString() == string.Empty)
                 {
                     if (Dsall.Tables[0].Rows[0]["SUPPLIER_SHIP_DAYS"] != null && Dsall.Tables[0].Rows[0]["SUPPLIER_SHIP_DAYS"].ToString() != "")
                     {
                         ...
                         if (shipping_time > 0 && shipping_time <= 14)
                         {
                            ...
                            if (ETA != "")
                            {
                                //st.SetAttribute("TBT_SHIPPINGDAYS", ETA);
                                st.SetAttribute("TBT_ISINSTOCK", false);
                                st.SetAttribute("TBT_SHOW_SHIPPINGDAYS", false);
                                st.SetAttribute("TBT_SHOW_ETA", true);
                                st.SetAttribute("TBT_ISINSTOCK_STAUS", "Pre-Order");
                                st.SetAttribute("TBT_SHIPPINGDAYS", "ETA: " + ETA);
                                st.SetAttribute("TBT_STOCK_HREF", "https://schema.org/PreOrder");
                            }
                            else
                            {
                                ...
                                st.SetAttribute("TBT_ISINSTOCK_STAUS", "Please Call");
                                st.SetAttribute("TBT_SHIPPINGDAYS", "Ships out within " + supplier_shipping_time);
                                st.SetAttribute("TBT_SHOW_ETA", false);
                                st.SetAttribute("TBT_STOCK_HREF", "https://schema.org/PreOrder");
                            }
                            //st.SetAttribute("TBT_SHOW_SHIPPINGDAYS", true);
                            return false;
                 ...
                 else if (availabilty > 0)
                 {
                     ...
                     if (avail_total >= stock_cutoff)
                     {
                        ...
                        else
                        {
                            ...
                            st.SetAttribute("TBT_ISINSTOCK_STAUS", "In Stock");
                            st.SetAttribute("TBT_SHIPPINGDAYS", "Ships out within " + supplier_shipping_time);
                            st.SetAttribute("TBT_STOCK_HREF", "https://schema.org/InStock");
                        }
                         //st.SetAttribute("TBT_STOCK_HREF", "https://schema.org/InStock");
                     }
                     else if (avail_total < stock_cutoff)
                     {
                        ...
                        else
                        {
                            ...
                            int soh = 0;
                            string tempstr = (string)objHelperDB.GetGenericDataDB(Pid.ToString(), "GET_PRODUCT_SOH", HelperDB.ReturnType.RTString);
                            if (tempstr != null && tempstr != "")
                                soh = Convert.ToInt32(tempstr);
                           // objErrorHandler.CreateLog("soh " + soh);
                            //soh = objProductServices.GetProductSOH(Convert.ToInt32(Pid.ToString()));
                            ...
                            {
                                st.SetAttribute("TBT_PLEASE_CALL", "true");
                                st.SetAttribute("TBT_STOCK_HREF", "https://schema.org/LimitedAvailability");
                            }
